#!/usr/bin/env python
#
# Register functional scan to anatomical space and unwarp.
...
parser.add_argument(
    "-a", "--anat", help="anatomical number (default: none)", default=""
)
parser.add_argument(
    "-f", "--fieldmap", help="fieldmap number (default: none)", default=""
)
parser.add_argument(
    "-p", "--pedir", default="y-", help="phase encoding direction (default: y-)"
)
...
fmapmagbrain = impath(map_dir, "fieldmap_mag_cor_brain{}".format(args.fieldmap))
